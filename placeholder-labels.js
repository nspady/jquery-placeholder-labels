function add_placeholders() {// encapsulate our variables into their own scope  
    // test if HTML5 placeholder is supported; if so, quit  
    if ('placeholder' in document.createElement('input')) {
      return;  
    }
  
    /* Go through each input and text area and add a placeholder label */
    $("input[placeholder], textarea[placeholder]").each(function(){  
      ...
      $input.bind('hide', function(){ $span.hide(); }); 
      ...
      $span.focus(function(){ $input.focus(); }); 
    }); 
